...
if($_POST){
    ...
    // 添加数据到数据库
    $insertid=add("department",$data);

    if($insertid){
        ShowMsg('添加部门成功','DepList.php');
        exit;
    }else{
        ShowMsg('添加部门失败');
        exit;
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane active in" id="home">
                                <form method="post" enctype="multipart/form-data">
                                    <label>部门名称</label>
                                    <input type="text" name="name" placeholder="请输入部门名称" class="input-xxlarge" required />
                                    <span id="notice" style="color:red;display:none;">该部门已存在</span>
